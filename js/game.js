document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!coinSound) {
    ...
    coinSound.src =
      "./assets/mp3/mixkit-hellhound-monster-attack-dog-wolf-creature-3015.mp3" // Replace with your sound file path
  ...
  var shopItems = [
    {
      ...
      cost: 10,
      type: "skin",
      imagePath: "./assets/img/barry.gif",
      category: "Skins",
      speed: 5,
    },
    {
      ...
      cost: 30,
      type: "skin",
      imagePath: "./assets/img/paper-dog.gif",
      category: "Skins",
      speed: 10,
    },
    {
      name: "Moonwalk Carlin Skin",
      cost: 50,
      type: "skin",
      imagePath: "./assets/img/carlin.gif",
      category: "Skins",
      speed: 15,
    },
    {
    ...
    {
      name: "Hover Animation - observing dog",
      cost: 5,
      type: "animation",
      className: "observing-dog-hover-button",
      category: "Animations",
    },
    { name: "Coin Dropper", cost: 20, type: "item", category: "Items" },
    {
      ...
      cost: 10,
      type: "sound",
      soundPath: "./assets/mp3/bark-guez.mp3",
      category: "Sounds",
    },
    {
      ...
      cost: 5,
      type: "scrollbar",
      imagePath: "./assets/img/dog-scroll.png",
      category: "Customizations",
    },
    {
      name: "Custom Scrollbar 2",
      cost: 5,
      type: "scrollbar",
      imagePath: "./assets/img/scroll2.png",
      category: "Customizations",
    },
    {
      name: "Magic Cursor",
      cost: 5,
      type: "cursor",
      cursorPath: "url(./assets/img/cursorhead.png) 32 32, auto",
      category: "Cursors",
    },
    {
      name: "Random Dog Word",
      cost: 5,
      type: "function",
      functionName: "generateRandomWordShopItem",
      category: "Functions",
    },
    {
      name: "Bark when type",
  ...
  shopButton.onclick = function () {
    shopContainer.style.display =
      shopContainer.style.display === "none" ? "block" : "none"
  }
  ...
  function applyAnimationToLinks(className) {
    document
      .querySelectorAll("a:not(header a):not(footer a)")
